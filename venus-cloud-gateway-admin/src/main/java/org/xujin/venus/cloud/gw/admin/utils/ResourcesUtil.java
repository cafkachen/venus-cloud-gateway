package org.xujin.venus.cloud.gw.admin.utils;
...
public class ResourcesUtil implements Serializable {
	...
	public static void main(String[] args) {
		...
		// 从资源文件取配置信息，需要传参
		System.out.println(
				getValue("resources.messages", "102", new Object[] { 100, 200 }));
		 ...
		 * ResourceBundle.getBundle("resources.messages", locale); String retValue =
		 * rb.getString("102");//101是messages.properties文件中的key
		 * System.out.println(retValue);
		 * 
		 * //信息格式化，如果资源中有{}的参数则需要使用MessageFormat格式化，Object[]为传递的参数，数量根据资源文件中的{}个数决定 String
		 * value = MessageFormat.format(retValue, new Object[]{100,200});
